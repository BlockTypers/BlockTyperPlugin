...
import com.blocktyper.v1_2_3.helpers.IClickedBlockHelper;
import com.blocktyper.v1_2_3.helpers.IPlayerHelper;
import com.blocktyper.v1_2_3.helpers.IVillagerHelper;
...
public abstract class BlockTyperUtility implements IBlockTyperUtility {
	...
	protected boolean itemHasExpectedNbtKey(ItemStack item, String recipeKey){
		return plugin.itemHasExpectedNbtKey(item, recipeKey);
	}
	...
	protected IVillagerHelper getVillagerHelper() {
		return plugin.getVillagerHelper();
	}
